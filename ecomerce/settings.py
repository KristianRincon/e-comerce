...
SECRET_KEY = 'django-insecure-#@335t^%+4jev1y&#5dkg=^8@xcmblli#dtpdg%(it_9!3vj*6'
...
# Ruta absoluta a la carpeta donde se almacenaran los archivos estaticos 
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')

#Carpetas adicionales de archivos estaticos
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'store/static'),
]


# Añadir configuraciones para archivos de medios
MEDIA_URL = '/media/'
...
EMAIL_HOST = 'smtp.gmail.com'  # Cambia esto por el servidor SMTP que estés usando
EMAIL_PORT = 587
EMAIL_USE_TLS = True
